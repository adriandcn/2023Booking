...
console.log('Precio seguro',num1);
			...
			.on("click.ab", ".abSelectorConfirm", function () {
				...
				pjQ.$.post([self.opts.folder, "index.php?controller=pjFront&action=pjActionBookingSave&cid=", self.opts.cid, "&check=", checkUpdatePrice, "&cupon=", valorCupon,"&datQ=", opts, "&cupon_id=",cuponID, "&session_id=", self.opts.session_id].join("")).done(function (data) {
