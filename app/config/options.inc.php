...
if (!defined("PJ_DB_HOST")) define("PJ_DB_HOST", "127.0.0.1");
if (!defined("PJ_DB_USERNAME")) define("PJ_DB_USERNAME", "iw-user");
if (!defined("PJ_DB_PASS")) define("PJ_DB_PASS", "G\$RJDZ4PuLD3xLBH@iw");
if (!defined("PJ_DB_NAME")) define("PJ_DB_NAME", "iWanaTv12020");

if (!defined("PJ_AWS_URL")) define("PJ_AWS_URL", "http://ec2-3-81-214-161.compute-1.amazonaws.com");

if (!defined("PJ_URL_LARAVEL")) define("PJ_URL_LARAVEL", PJ_AWS_URL.":82");
if (!defined("PJ_URL_LARAVEL1")) define("PJ_URL_LARAVEL1", "https://iwannatrip.com");
if (!defined("PJ_URL_BOOKING")) define("PJ_URL_BOOKING", "https://bookiw.iwannatrip.com");

if (!defined("PJ_URL_UPLOAD")) define("PJ_URL_UPLOAD", "/var/www/html/BookiW/app/web/");
